...
for sentence_size in sentence_size_list:
    for score in score_list:
        ...
        result_list = []
        # with open("/root/projects/neutrino/langchain-ChatGLM/query/filtered_quora.jsonl") as file, \
        #     open("/root/projects/neutrino/langchain-ChatGLM/query/machine_learning/filtered_quora/machine_learning_query_eval_score_" + \
        #         str(score) + "_sentence_size_" + str(sentence_size), "w") as file2:
        with open("/root/renxueying/query_reacall/chinaLaw/yuliang/350/newquestion_350.json") as file, \
            open("/root/renxueying/query_reacall/chinaLaw/recall/350/newquestion_350", "w") as file2:
            for line in file:
                json_obj = json.loads(line.rstrip())
                origin_query = json_obj["question"]
                # query_keywords = json_obj["gpt_result"]
                # recall_list = recall_eval.get_knowledge_based_answer(origin_query, \
                #     "/root/projects/neutrino/langchain-ChatGLM/vector_store/machine_learning_abstract_conclusion_sentence_" + str(sentence_size))
                recall_list = recall_eval.get_knowledge_based_answer(origin_query, \
                    "/root/projects/neutrino/langchain-ChatGLM/vector_store_with_year/chinaLaw/2021")
